...
# with command line options: Configuration/Generator/python/PYTHIA6_Tauola_SM_H_2Tau_zh_mH160_7TeV_cff.py -s GEN,SIM --conditions START42_V14B::All --eventcontent FEVTSIM --datatier GEN-SIM-RAW --pileup NoPileUp -n 10 --no_exec
...
process.FEVTSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_Tauola_SM_H_2Tau_zh_mH160_7TeV_cff_py_GEN_SIM.root'),
