...
# with command line options: Configuration/Generator/python/PYTHIA6_Tauola_SM_H_2W_2lnu_zh_mH120_7TeV_cff.py -s GEN --conditions START42_V14B::All --eventcontent FEVT --datatier GEN-SIM-RAW --pileup NoPileUp -n 10 --no_exec
...
process.FEVToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_Tauola_SM_H_2W_2lnu_zh_mH120_7TeV_cff_py_GEN.root'),
