...
do
  ...
  echo "CMSSW.datasetpath=/ZH_ZToLL_HToWW_WWTo2LNu-$mass-7TeV-pythia6/friis-ZH_ZToLL_HToTauTau_M-$mass-7TeV-pythia6_crab_digi_WW_$mass-b94ed3ce6183d233f3644e7c7592cbfd/USER" >> multicrab.cfg
  echo "" >> multicrab.cfg
